...
class Comment < ActiveRecord::Base
  ...
  # NOTE: Since we're allowing anonymous comments, requiring no user account,
  # we don't want to be creating a database record for every new username.
  # We generated a migration to add a "username" field to the "comments" table
  # and that's what we'll be requiring the presence of.
