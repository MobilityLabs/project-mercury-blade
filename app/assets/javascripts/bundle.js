...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5),
	    ...
	    CommentsList = __webpack_require__(163),
	    css = __webpack_require__(167);
	
	var comments = window.comments;
	
	ReactDOM.render(React.createElement(CommentsList, { comments: comments }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5),
	    Comment = __webpack_require__(164);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.props.comments.map(function (comment) {
	        return React.createElement(Comment, { key: comment.id, comment: comment, nesting: 0 });
	      })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5),
	    CommentForm = __webpack_require__(165),
	...
	var Comment = React.createClass({
	  ...
	  createComment: function createComment(newComment) {
	    ...
	    var url = window.location + '/add_comment';
	    $.ajax({
	      url: url,
	      method: 'POST',
	      data: {
	      ...
	      success: function success() {
	        _this.setState({
	          comment: {
	            ...
	            children: [].concat(_toConsumableArray(comment.children), [newComment])
	          }
	        });
	      }
	    });
	  ...
	  render: function render() {
	    var comment = this.state.comment;
	    var nestingLevel = this.props.nesting;
	
	    var form = '';
	    if (this.state.shouldShowForm) {
	      form = React.createElement(CommentForm, { onCreateComment: this.createComment, parent: comment });
	    }
	    return React.createElement(
	      'div',
	      ...
	      React.createElement(
	        ...
	        comment.children.map(function (child) {
	          return React.createElement(Comment, { key: child.id, comment: child, nesting: nestingLevel + 1 });
	        })
	      ),
	      React.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentForm = React.createClass({
	  ...
	  updateAuthor: function updateAuthor(event) {
	  ...
	  submitComment: function submitComment(e) {
	    ...
	    this.props.onCreateComment({ author: author, content: content, parentId: this.props.parent.id });
	    this.setState({ author: '', content: '' });
	
	    e.preventDefault();
	  },
	  render: function render() {
	    var canSubmit = this.state.author !== '' && this.state.content !== '';
	
	    return React.createElement(
	      'form',
	      { className: 'comment-form', onSubmit: this.submitComment },
	      React.createElement(
	        'div',
	        { className: 'form-group' },
	        React.createElement(
	          'label',
	          { htmlFor: 'comment-name' + this.props.parent.id },
	          'Name'
	        ),
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'label',
	          { htmlFor: 'comment-content' + this.props.parent.id },
	          'Comment'
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "9315aaa548940abbbf21328b47b0ff6f.jpg";
