...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5),
	    ...
	    css = __webpack_require__(168);
	
	ReactDOM.render(React.createElement(CommentsList, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5),
	    API = __webpack_require__(164),
	    Comment = __webpack_require__(166),
	    CommentForm = __webpack_require__(167);
	...
	var CommentsList = React.createClass({
	  ...
	  createComment: function createComment(comment) {
	    ...
	    API.createComment(comment).then(function (response) {
	      var newComment = response.comment;
	      _this.setState({
	        comments: [newComment].concat(_toConsumableArray(_this.state.comments))
	      });
	    });
	  },
	  render: function render() {
	    ...
	    var topLevelComments = this.state.comments.filter(function (comment) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Comment = React.createClass({
	  ...
	  getComment: function getComment() {
	    ...
	    return this.props.comments.find(function (comment) {
	      return comment.id === _this.props.commentId;
	    });
	  },
	  getChildren: function getChildren() {
	    ...
	    return this.props.comments.filter(function (comment) {
	      return comment.parent_id === _this2.props.commentId;
	    });
	  },
	  render: function render() {
	    var _this3 = this;
	    ...
	    if (this.state.shouldShowForm) {
	      form = React.createElement(CommentForm, { onCreateComment: this.props.onCreateComment, parent: comment });
	    }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        children.map(function (child) {
	          return React.createElement(Comment, { key: child.id,
	            commentId: child.id,
	            comments: comments,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Nunito:400,700|Open+Sans:400,700);", ""]);
